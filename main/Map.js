  ...
  _createClass(Map, [{
    ...
    get: function get() {
      ...
      return _react2.default.Children.map(children, function (child) {
        (0, _invariant2.default)(child == null || child.type[_symbols2.default.GeoObject] || child.type[_symbols2.default.Control], 'A <Map> children should be <GeoObject> or <Control> components');
